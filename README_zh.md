...
- [现有综述 ](#现有综述 )
- [大模型可应用在心理健康领域的实证依据 ](#大模型可应用在心理健康领域的实证依据 )
- [大模型在心理健康临床场景的应用](#大模型在心理健康临床场景的应用)
...
[20]SCHAAFF K, REINIG C, SCHLIPPE T. Exploring chatgpt’s empathic abilities[C]//2023 11th international conference on affective computing and intelligent interaction (ACII). 2023: 1-8.
...
[25]ZHOU J, CHEN Z, WAN D, et al. CharacterGLM: Customizing social characters with large language models[C/OL]//DERNONCOURT F, PREOŢIUC-PIETRO D, SHIMORINA A. Proceedings of the 2024 Conference on Empirical Methods in Natural Language Processing: Industry Track. 2024: 1457-1476.
...
[29]JIANG G, XU M, ZHU S C, et al. Evaluating and inducing personality in pre-trained language models[C]//NIPS ’23: Proceedings of the 37th International Conference on Neural Information Processing Systems. 2023.
...
[35]HOANG V, ROGERS E, ROSS R. How can client motivational language inform psychotherapy agents?[C/OL]//YATES A, DESMET B, PRUD’HOMMEAUX E, et al. Proceedings of the 9th Workshop on Computational Linguistics and Clinical Psychology (CLPsych 2024). 2024: 23-40.
...
[41]KIM T, BAE S, KIM H A, et al. Mindfuldiary: Harnessing large language model to support psychiatric patients’ journaling[C/OL]//CHI ’24: Proceedings of the 2024 CHI Conference on Human Factors in Computing Systems. 2024.
...
[47]CHEN Y, XING X, LIN J, et al. SoulChat: Improving LLMs’ empathy, listening, and comfort abilities through fine-tuning with multi-turn empathy conversations[C/OL]//BOUAMOR H, PINO J, BALI K. Findings of the Association for Computational Linguistics: EMNLP 2023. 2023: 1170-1183.
...
[56]HU Y, TAN M, ZHANG C, et al. Aptness: Incorporating appraisal theory and emotion support strategies for empathetic response generation[C/OL]//CIKM ’24: Proceedings of the 33rd ACM International Conference on Information and Knowledge Management. 2024: 900–909.
...
[58]YANG D, ZHU J, WU H, et al. Cascadercg: Retrieval-augmented generation for enhancing professionalism and knowledgeability in online mental health support[C/OL]//WWW ’25: Companion Proceedings of the ACM on Web Conference 2025. 2025: 1465–1469.
...
[65]LIU C C, ARNAOUT H, KOVAčIć N, et al. Tailored emotional llm-supporter: Enhancing cultural sensitivity[EB/OL]. 2025. https://arxiv.org/abs/2508.07902. [2025-10-25]

[66]JOHN O P, DONAHUE E M, KENTLE R L. Big five inventory[J]. Journal of personality and social psychology, 1991.

[67]BAGBY R, PARKER J D, TAYLOR G J. The twenty-item toronto alexithymia scale—i. item selection and cross-validation of the factor structure[J/OL]. Journal of Psychosomatic Research, 1994, 38(1): 23-32.
...
[73]KRUPAT E, FRANKEL R, STEIN T, et al. The four habits coding scheme: validation of an instrument to assess clinicians’ communication behavior[J]. Patient education and counseling, 2006, 62: 38-45.
...
[82]SZYMANSKI A, ZIEMS N, EICHER-MILLER H A, et al. Limitations of the llm-as-a-judge approach for evaluating llm outputs in expert knowledge tasks[C/OL]//IUI ’25: Proceedings of the 30th International Conference on Intelligent User Interfaces. 2025: 952–966.


# 现存挑战

[83]ERIKSEN A V, MÖLLER S, RYG J. Use of gpt-4 to diagnose complex clinical cases[J]. Nejm Ai, 2024, 1(1): AIp2300031.
...
[85]OBRADOVICH N, KHALSA S S, KHAN W U, et al. Opportunities and risks of large language models in psychiatry[J]. NPP—Digital Psychiatry and Neuroscience, 2024, 2(1): 8.
...
[91]ASGARI E, MONTAÑA-BROWN N, DUBOIS M, et al. A framework to assess clinical safety and hallucination rates of llms for medical text summarisation[J]. npj Digital Medicine, 2025, 8(1): 274.
...
[94]ROUSTAN D, BASTARDOT F, et al. The clinicians’guide to large language models: A general perspective with a focus on hallucinations[J]. Interactive journal of medical research, 2025, 14(1): e59823.
